    ...
    constructor(container, options) {
        ...
        this.onProp && this.onProp({
            ...
            args: {
                ...
                bonds: '[' + ((_a = this.bonds) === null || _a === void 0 ? void 0 : _a.map((b) => b.link).join(', ')) + ']'
            },
            method: 'create',
...
function fixBondIndexes(node, newIndex) {
    ...
    lastBond.to.forEach(bond => {
        let compTo = this.container.get(bond.id), compToBonds = compTo === null || compTo === void 0 ? void 0 : compTo.nodeBonds(bond.ndx);
