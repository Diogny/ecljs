...
import { INodeInfo, ContainerMapType } from "./interfaces";
...
export declare const getItem: <T extends ItemBoard>(container: Container<T>, id: string) => ContainerMapType<Wire | T> | undefined;
